...
export function CommandPalette({
  ...
  const actions = useMemo<PaletteAction[]>(() => [
    ...
    { id: 'surface_chat',         label: 'Switch to Workspace',                        group: 'Surfaces', run: () => { onSwitchSurface('chat');       onClose() } },
    { id: 'surface_notes',        label: 'Switch to Notes',                            group: 'Surfaces', run: () => { onSwitchSurface('notes');       onClose() } },
    { id: 'surface_cowork',       label: 'Switch to Cowork',                           group: 'Surfaces', run: () => { onSwitchSurface('cowork');      onClose() } },
    { id: 'surface_workrooms',    label: 'Switch to Workrooms',                        group: 'Surfaces', run: () => { onSwitchSurface('workrooms');   onClose() } },
