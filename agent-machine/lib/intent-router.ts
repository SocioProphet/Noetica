...
export type Tool = 'read_file' | 'write_file' | 'edit_file' | 'list_directory' | 'code_execute' | 'web_search' | 'generate_image' | 'remember' | 'ocr' | 'run_command' | 'scaffold_app' | 'registry_lookup' | 'render_chart' | 'brain_status' | 'update_self' | 'set_identity' | 'find_symbol' | 'execute_action' | 'acquire'
...
const INTENTS: Intent[] = [
  ...
  { id: 2, name: 'research_lookup', model: 'research', retrieval: 'web+vector', slots: ['question', 'sources'], tools: ['web_search', 'read_file', 'acquire'], surface: 'canvas', skill: 'research-agent', cues: /\b(research|find out|look up|search for|who (is|was|discovered)|when did|latest|how much|what'?s the (price|salary|rate))\b/i },
