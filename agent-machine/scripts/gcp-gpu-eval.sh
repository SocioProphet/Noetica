...
OLLAMA_HOST=http://127.0.0.1:11434 OCW_BRAIN=/opt/OCW/_brain \
  MMLU_MODEL=$MODEL MMLU_ARMS=$ARMS MMLU_PER_SUBJECT=$PER MMLU_SEED=1729 MMLU_SUBJECTS=$SUBJECTS MMLU_MAX_CHUNKS=$MAXCHUNKS MMLU_CONC=8 MMLU_CISC=${CISC:-1} MMLU_HYBRID=${HYBRID:-1} MMLU_NO_THINK=${NO_THINK:-0} MMLU_MANIP=${MANIP:-1} \
