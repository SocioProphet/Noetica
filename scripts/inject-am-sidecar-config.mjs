...
if (restore) {
  ...
  config.bundle.externalBin = ['binaries/agent-machine', 'binaries/ollama']
  console.log('Injected externalBin: ["binaries/agent-machine", "binaries/ollama"] into tauri.conf.json')
}
